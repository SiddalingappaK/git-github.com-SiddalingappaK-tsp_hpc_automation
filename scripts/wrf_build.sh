...
#       $ wrf_build.sh                                                                  #
#                                                                                       #
#       Supported Compiler : AOCC, GCC, ICC                                             #
#       Supported Parallelism : MPI , IntelMPI                                          #
#---------------------------------------------------------------------------------------#
echo "#===========================================================================================================#"
echo "#                                                                                                           #"
...
do
    case $1 in
            --wrf_version)
                echo "wrf_version : $2"
                export wrf_version=$2
            ;;
            --wrf_compiler)
                echo "wrf_compiler : $2"
                export wrf_compiler=$2
            ;;
            --wrf_compiler_version)
                echo "wrf_compiler_version : $2"
                export wrf_compiler_version=$2
            ;;
            --wrf_mpi)
                echo "wrf_mpi : $2"
                export wrf_mpi=$2
            ;;
            --wrf_mpi_compiler)
                echo "wrf_mpi_compiler : $2"
                export wrf_mpi_compiler=$2    
            ;;
            --wrf_mpi_compiler_version)
                echo "wrf_mpi_compiler_version : $2"
                export wrf_mpi_compiler_version=$2    
            ;;
            --wrf_mpi_flags)
                echo "wrf_mpi_flags : $2"
                export wrf_mpi_flags=$2
            ;;
            --wrf_flags)
                echo "wrf_flags : $2"
                export wrf_flags=$2
            ;;
            --wrf_jemalloc_version)
                echo "wrf_jemalloc_version : $2"
                export wrf_jemalloc_version=$2    
            ;;
            --wrf_jemalloc_compiler)
                echo "wrf_jemalloc_compiler : $2"
                export wrf_jemalloc_compiler=$2    
            ;;
            --wrf_jemalloc_compiler_version)
                echo "wrf_jemalloc_compiler_version : $2"
                export wrf_jemalloc_compiler_version=$2    
            ;;
            --wrf_jemalloc_flags)
                echo "wrf_jemalloc_flags : $2"
                export wrf_jemalloc_flags=$2    
            ;;
            --wrf_hdf5_version)
                echo "wrf_hdf5_version : $2"
                export wrf_hdf5_version=$2    
            ;;
            --wrf_hdf5_mpi)
                echo "wrf_hdf5_mpi : $2"
                export wrf_hdf5_mpi=$2    
            ;;
            --wrf_hdf5_mpi_version)
                echo "wrf_hdf5_mpi_version : $2"
                export wrf_hdf5_mpi_version=$2    
            ;;
            --wrf_hdf5_mpi_compiler)
                echo "wrf_hdf5_mpi_compiler : $2"
                export wrf_hdf5_mpi_compiler=$2    
            ;;
            --wrf_hdf5_mpi_compiler_version)
                echo "wrf_hdf5_mpi_compiler_version : $2"
                export wrf_hdf5_mpi_compiler_version=$2    
            ;;
            --wrf_hdf5_mpi_flags)
                echo "wrf_hdf5_mpi_flags : $2"
                export wrf_hdf5_mpi_flags=$2    
            ;;
            --wrf_hdf5_flags)
                echo "wrf_hdf5_flags : $2"
                export wrf_hdf5_flags=$2    
            ;;
            --wrf_pnetcdf_version)
                echo "wrf_pnetcdf_version : $2"
                export wrf_pnetcdf_version=$2    
            ;;
            --wrf_pnetcdf_mpi)
                echo "wrf_pnetcdf_mpi : $2"
                export wrf_pnetcdf_mpi=$2    
            ;;
            --wrf_pnetcdf_mpi_version)
                echo "wrf_pnetcdf_mpi_version : $2"
                export wrf_pnetcdf_mpi_version=$2    
            ;;
            --wrf_pnetcdf_mpi_compiler)
                echo "wrf_pnetcdf_mpi_compiler : $2"
                export wrf_pnetcdf_mpi_compiler=$2    
            ;;
            --wrf_pnetcdf_mpi_compiler_version)
                echo "wrf_pnetcdf_mpi_compiler_version : $2"
                export wrf_pnetcdf_mpi_compiler_version=$2    
            ;;
            --wrf_pnetcdf_mpi_flags)
                echo "wrf_pnetcdf_mpi_flags : $2"
                export wrf_pnetcdf_mpi_flags=$2    
            ;;
            --wrf_pnetcdf_flags)
                echo "wrf_pnetcdf_flags : $2"
                export wrf_pnetcdf_flags=$2    
            ;;
            --wrf_netcdfc_version)
                echo "wrf_netcdfc_version : $2"
                export wrf_netcdfc_version=$2
            ;;
            --wrf_netcdff_version)
                echo "wrf_netcdff_version : $2"
                export wrf_netcdff_version=$2
            ;;
            --wrf_netcdf_mpi)
                echo "wrf_netcdf_mpi : $2"
                export wrf_netcdf_mpi=$2
            ;;
            --wrf_netcdf_mpi_version)
                echo "wrf_netcdf_mpi_version : $2"
                export wrf_netcdf_mpi_version=$2
            ;;
            --wrf_netcdf_mpi_compiler)
                echo "wrf_netcdf_mpi_compiler : $2"
                export wrf_netcdf_mpi_compiler=$2
            ;;
            --wrf_netcdf_mpi_compiler_version)
                echo "wrf_netcdf_mpi_compiler_version : $2"
                export wrf_netcdf_mpi_compiler_version=$2
            ;;
            --wrf_netcdf_mpi_flags)
                echo "wrf_netcdf_mpi_flags : $2"
                export wrf_netcdf_mpi_flags=$2
            ;;
            --wrf_netcdf_hdf5_version)
                echo "wrf_netcdf_hdf5_version : $2"
                export wrf_netcdf_hdf5_version=$2
            ;;
            --wrf_netcdf_pnetcdf_version)
                echo "wrf_netcdf_pnetcdf_version : $2"
                export wrf_netcdf_pnetcdf_version=$2
            ;;
            --wrf_netcdf_flags)
                echo "wrf_netcdf_flags : $2"
                export wrf_netcdf_flags=$2
            ;;
            --help)
                wrf_usage
                exit
